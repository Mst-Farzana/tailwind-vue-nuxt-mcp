...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-6" }, _attrs))}><h1>Forgot Password</h1><p>Reset your password here.</p></div>`);
}
...
//# sourceMappingURL=forgot-password-CITVHt_S.mjs.map
