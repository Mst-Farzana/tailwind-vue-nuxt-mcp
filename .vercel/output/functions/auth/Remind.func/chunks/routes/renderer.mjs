...
import { P as buildAssetsURL, Q as useRuntimeConfig, R as getResponseStatusText, S as getResponseStatus, T as defineRenderHandler, U as publicAssetsURL, j as getQuery, c as createError, V as destr, W as getRouteRules, X as joinURL, u as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.svg"}],"style":[],"script":[],"noscript":[],"title":"My Nuxt App","htmlAttrs":{"class":""}};
